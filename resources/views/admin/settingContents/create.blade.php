...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.settingContent.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.setting-contents.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label for="tag_line_product">{{ trans('cruds.settingContent.fields.tag_line_product') }}</label>
                <input class="form-control {{ $errors->has('tag_line_product') ? 'is-invalid' : '' }}" type="text" name="tag_line_product" id="tag_line_product" value="{{ old('tag_line_product', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('url_video') ? 'is-invalid' : '' }}" type="text" name="url_video" id="url_video" value="{{ old('url_video', '') }}">
